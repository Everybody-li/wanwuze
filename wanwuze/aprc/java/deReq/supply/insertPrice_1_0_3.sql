...
-- ##input quantity string[50] NOTNULL;采购数量，必填
-- ##input unitFee string[50] NOTNULL;单价，必填
...
insert into
    coz_demand_request_price( guid, request_guid, request_supply_guid, user_id, model_guid, model_name, bank_user_name
                            , bank_name, bank_user_no, bank_addr, supply_company_name, supply_price, supply_price_time
                            , unit_fee, quantity, logistics_fee, logistics_insurance_fee, demand_service_fee
                            , demand_service_fee_remark, supply_service_fee, supply_service_fee_remark, tax_fee
                            , discount_fee, selected_flag, distance, total_fee, del_flag, create_by, create_time
