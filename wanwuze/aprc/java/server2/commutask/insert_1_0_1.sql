...
-- ##input commuTaskGuid string[36] NOTNULL;品类名称guid，必填
...
insert into coz_serve2_commu_task(guid,user_id,start_date,end_date,sd_path_guid,pfelang_guid,bizdict2_guid,target_object_num,del_flag,create_by,create_time,update_by,update_time)
select
'{commuTaskGuid}' as guid
