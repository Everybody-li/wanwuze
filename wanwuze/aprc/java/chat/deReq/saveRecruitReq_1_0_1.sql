...
-- ##input guid char[36] NOTNULL;招聘需求guid，必填
...
insert into coz_chat_supply_request(guid,user_id,user_name,user_phone,reimg,sd_path_guid,sd_path_all_name,category_guid,category_name,category_img,category_alias,send_type,send_time,del_flag,create_by,create_time,update_by,update_time)
select
'{guid}' as guid
,'{userId}' as user_id
