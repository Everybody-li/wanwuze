...
-- ##input allParentCode string[200] NULL;当前节点的组系节点，必填
...
and ( not exists(select 1 from sys_city_code_hasnone where id in ({selectedFlag1Id}) and t.all_parent_code like concat('%',all_parent_code,'%')) or '{selectedFlag1Id}'='''');
