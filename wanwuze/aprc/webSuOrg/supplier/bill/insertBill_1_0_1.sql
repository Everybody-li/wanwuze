-- ##Title app-供应-按单-新增需求范围内容
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe app-供应-按单-新增需求范围内容
-- ##CallType[ExSql]
...
-- ##input plateCode string[20] NOTNULL;板块名称code，必填
...
insert into coz_category_supplier_bill(guid,supplier_guid,plate_formal_guid,plate_code,plate_formal_alias,plate_norder,plate_field_formal_guid,plate_field_formal_alias,plate_field_code,plate_field_norder,plate_field_content_gc,operation,plate_field_value,plate_field_value_remark,del_flag,create_by,create_time)
select
uuid() as guid
...
,now()
;
delete from coz_biz_city_code_temp where biz_guid='{supplierGuId}'
;