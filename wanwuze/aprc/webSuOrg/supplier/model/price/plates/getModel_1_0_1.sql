...
-- ##input modelPriceGuid string[36] NOTNULL;供方品类型号Guid，必填
...
,CONCAT('{ChildRows_aprc\\webSuOrg\\supplier\\model\\price\\plates\\getPlates_1_0_1:modelPriceGuid=''',t.guid,'''}') as `plate`
from
