...
-- ##input supplyPathGuid char[36] NOTNULL;供应路径guid'
-- ##input categoryGuid char[36] NOTNULL;供应路径guid'
-- ##input recommedType string[1] NOTNULL;推荐类型（1-严格匹配规则推荐，2-系统推荐）'
...
,left(t1.create_time,16) as mtNeCreateTime -- 改为提出需求时间
