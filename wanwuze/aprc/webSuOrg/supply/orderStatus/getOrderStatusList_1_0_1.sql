-- ##Title app-供应-查询订单状态管理列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe app-供应-查询订单状态管理列表
-- ##CallType[QueryData]

-- ##input curUserId string[36] NULL;供方用户id，必填
-- ##input sdPathGuid char[36] NOTNULL;品类类型guid，必填
...
where 
t.supply_user_id=''{curUserId}'' and t.del_flag=''0'' and t.sd_path_guid=''{sdPathGuid}'' and t.pay_status=''2'' and (t.order_no like''%{orderNo}%'' or ''{orderNo}''='''')
order by t.id desc
limit ?,?;
';
