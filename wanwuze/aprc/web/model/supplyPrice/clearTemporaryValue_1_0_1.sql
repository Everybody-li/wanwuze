...
update coz_category_supply_price t
set publish_time=now()
where (cattype_guid='{categoryGuid}' and exists(select 1 from coz_model_plate_formal where temp_guid is not null and category_guid=t.category_guid and biz_type='2')) or category_guid='{categoryGuid}'
;
...
,t.del_flag='0'
,t.publish_flag='2'
where (t.temp_guid is not null and t.temp_guid<>'') and t.del_flag='2' and t.biz_type='2' and t.cattype_guid='{categoryGuid}' and t1.guid is not null
;
...
,publish_flag='2'
,publish_time=now()
where (temp_guid is not null and temp_guid<>'') and del_flag='2' and biz_type='2' and cattype_guid='{categoryGuid}'
;
