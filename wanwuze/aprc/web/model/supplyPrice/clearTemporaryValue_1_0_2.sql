...
,t.update_time = now()
,t.update_by = '{curUserId}'
where (t.temp_guid is not null and t.temp_guid<>'') and t.del_flag='2' and t.biz_type='2' and t.category_guid='{categoryGuid}' and t1.guid is not null
;
...
,update_time = now()
,update_by = '{curUserId}'
where (temp_guid is not null and temp_guid<>'') and del_flag='2' and biz_type='2' and category_guid='{categoryGuid}'
;
