...
-- ##output bizType int[>=0] 1;业务类型：1-供需需求信息配置，2-供应报价信息配置，3-简历需求信息配置，4-采购资质信息配置
...
,case when (t.operation='0' or t.content_source='0' or ((t.operation='1' or t.operation='2') and (t.content_source='1' or t.content_source='2') and not exists(select 1 from coz_model_plate_field_content where plate_field_guid=t.guid and del_flag='0'))) then '0' else '1' end as contOpFlag
from
...
where 
t.cat_tree_code='{catTreeCode}' and t.category_guid='{categoryGuid}' and t.biz_type='{bizType}' and t.del_flag='0'
