...
(
select
(select name from coz_model_fixed_data where code='f00007') as demandName
,t1.name as supplyName
,t1.code as fixedDataCode
from
coz_model_fixed_data t1
where 
(t1.code='f00008') and '{fixedDataCode}'='f00007' and t1.name!=''
)t
where 
not exists(select 1 from coz_model_plate_field where name=t.fixedDataCode and category_guid='{categoryGuid}'and del_flag='0' and cat_tree_code='supply' and biz_type='1')