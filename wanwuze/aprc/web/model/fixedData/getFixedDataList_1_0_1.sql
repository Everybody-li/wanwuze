...
-- ##input bizType int[>=0] NULL;业务类型：1：需求信息，2：报价信息，4：资质信息，非必填
...
where type={type} and (name like '%{name}%' or '{name}'='') and (biz_type='{bizType}' or '{bizType}'='') and 
(display_type='1' or display_type='2') and del_flag='0'
