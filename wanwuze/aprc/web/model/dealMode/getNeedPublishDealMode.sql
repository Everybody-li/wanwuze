...
coz_category_deal_mode t
where 
cattype_guid='{categoryGuid}' and category_guid<>cattype_guid and not exists(select 1 from coz_model_plate_formal where t.category_guid=category_guid and biz_type=1 and del_flag='0') and t.del_flag='0'
