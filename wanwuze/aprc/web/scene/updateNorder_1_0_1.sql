...
set @parentguid=(select parent_guid from coz_category_scene_tree where guid ='{guid}' and del_flag='0')
;
set @flag1=case when((select norder from coz_category_scene_tree where guid='{guid}')={oldNorder}) then 1 else 0 end
;
