...
,CAST((t.supply_fee/100) AS decimal(18,2)) as shouldPayFee
,CAST((t.discount_fee/100) AS decimal(18,2)) as discountFee
,(CAST((t.supply_fee/100) AS decimal(18,2))-CAST((t.discount_fee/100) AS decimal(18,2))) as payFee
