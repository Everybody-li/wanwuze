-- ##Title web-结算管理-未结算列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-结算管理-未结算列表
-- ##CallType[QueryData]

-- ##input month string[7] NOTNULL;裁决结果月份（格式：0000-00），必填
...
where 
left(t.create_time,7)=''{month}'' and t.del_flag=0 and (t1.order_no like ''%{orderNo}%'' or ''{orderNo}''='''') and t.confirm_pay_flag=''1'' and t4.disobey_object=''2'' and t.fee_type=''2''
