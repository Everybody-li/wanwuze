...
-- ##output refundPayProveTime string[10] 0000-00-00;提交付款证明日期（格式：0000-00-00）
...
,left(t.confirm_pay_time,10) as refundPayProveTime
...
where 
left(t.create_time,7)=''{month}'' and t.del_flag=0 and (t1.order_no like ''%{orderNo}%'' or ''{orderNo}''='''') and t.confirm_pay_flag=''2'' and t4.disobey_object=''2'' and t.fee_type=''2''
