...
where 
left(t.create_time,7)=''{month}'' and t.del_flag=0 and (t1.order_no like ''%{orderNo}%'' or ''{orderNo}''='''') and t.fee_type=''1'' and t4.disobey_object=''2'' and t.confirm_pay_flag=''1''
