...
-- ##output refundPayTime string[10] 0000-00-00;退款支付时间（格式：0000-00-00）
...
,left(t.confirm_refund_pay_time,10) as confirmRefundPayProveTime
,left(t.supply_accept_time,10) as supplayAcceptTime
,left(t.refund_pay_time,10) as refundPayTime
...
where 
left(t.create_time,7)=''{month}'' and t.del_flag=''0'' and (t1.order_no like ''%{orderNo}%'' or ''{orderNo}''='''') and t.supply_accept=''1'' and (t4.result=''1'' or t4.result=''2'')
union all
select
t4.guid as judgeGuid
,t.guid as refundGuid
,left(t4.result_time,10) as judgeTime
,left(t.supply_done_time,10) as confirmRefundPayProveTime
,left(t.supply_done_time,10) as supplayAcceptTime
,left(t.refund_pay_time,10) as refundPayTime
,t2.name as categoryName
,t2.cattype_name as cattypeName
,t1.order_no as orderNo
...
,t1.supply_user_id as supplyUserId
,cast(t.refund_fee/100 as decimal(18,2)) as refundFee
,t.supply_done_flag as supplyAccept
,t1.request_guid as requestGuid
,t1.request_price_guid as requestPriceGuid
,''1'' as demandUserType
,''2'' as supplyUserType
...
on t1.demand_user_id=t3.guid
where 
left(t.create_time,7)=''{month}'' and t.del_flag=''0'' and (t1.order_no like ''%{orderNo}%'' or ''{orderNo}''='''') and t.supply_done_flag=''1'' and (t4.result=''1'' or t4.result=''2'')
)t
