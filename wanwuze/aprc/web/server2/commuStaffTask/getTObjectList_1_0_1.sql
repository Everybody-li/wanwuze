...
on t2.guid=t3.object_guid
where 
(t2.phonenumber like''%{phonenumber}%'' or ''{phonenumber}''='''') and t1.del_flag=''0'' and t2.del_flag=''0'' and t3.del_flag=''0'' and t1.serve_task_guid=''{serveTaskGuid}'' 
