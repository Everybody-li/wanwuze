-- ##Title web-查询服务对象联系管理
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-查询服务对象联系管理
-- ##CallType[QueryData]
...
where 
(t4.phonenumber like''%{sdPName}%'' or t5.org_name like''%{sdPName}%'' or t6.name like''%{sdPName}%'' or ''{sdPName}''='''') and t1.user_id=''{curUserId}''
and t1.del_flag=''0'' and t2.del_flag=''0'' and t4.del_flag=''0'' and t5.del_flag=''0'' and t6.del_flag=''0'' and t3.guid is null
