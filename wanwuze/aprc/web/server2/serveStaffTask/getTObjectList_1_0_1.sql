-- ##Title web-查询服务任务的目标用户列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-查询服务任务的目标用户列表
-- ##CallType[QueryData]
...
where 
(t2.phonenumber like''%{phonenumber}%'' or t3.org_name like''%{phonenumber}%'' or ''{phonenumber}''='''') and t1.del_flag=''0'' and t2.del_flag=''0'' and t3.del_flag=''0'' and t1.serve_task_guid=''{serveTaskGuid}'' 
