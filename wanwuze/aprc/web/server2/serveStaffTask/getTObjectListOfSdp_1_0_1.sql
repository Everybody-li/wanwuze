-- ##Title web-查询意向预约统计的目标用户详情列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-查询意向预约统计的目标用户详情列表
-- ##CallType[QueryData]

-- ##input phonenumber string[11] NULL;机构名称(模糊搜索)，非必填
-- ##input serveTaskGuid string[36] NOTNULL;沟通任务guid，必填
-- ##input sdPathGuid string[36] NOTNULL;沟通任务guid，必填
...
where 
(t2.phonenumber like''%{phonenumber}%'' or t3.org_name like''%{phonenumber}%'' or ''{phonenumber}''='''') and t1.del_flag=''0'' and t2.del_flag=''0'' and t3.del_flag=''0'' and t4.del_flag=''0'' and t1.serve_task_guid=''{serveTaskGuid}'' and t4.sd_path_guid=''{sdPathGuid}''
order by t1.id desc
limit ?,?;
';
