-- ##Title web-查询服务信息应用管理
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-查询服务信息应用管理
-- ##CallType[QueryData]
...
where 
(t4.phonenumber like''%{sdPName}%'' or t5.org_name like''%{sdPName}%'' or t6.name like''%{sdPName}%'' or ''{sdPName}''='''') and t1.user_id=''{curUserId}''and t1.del_flag=''0'' and t2.del_flag=''0'' and t3.del_flag=''0'' and t4.del_flag=''0'' and t5.del_flag=''0'' and t6.del_flag=''0'' and t3.progress=''2'' and t3.result=''1'' and not exists(select 1 from coz_serve2_serve_task_tobject_result where serve_task_tobject_guid=t2.guid and progress=''3'' and del_flag=''0'')
