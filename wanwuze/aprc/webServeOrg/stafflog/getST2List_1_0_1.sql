...
inner join
coz_serve_org t2
on t.seorg_guid=t2.guid
where t1.del_flag=''0'' and t.del_flag=''0'' and t.detach_flag=''0'' and t.seorg_guid=''{curUserId}'' and (t1.user_name like ''%{userName}%'' or t1.phonenumber like ''%{userName}%'' or ''{userName}''='''')
union all
select
t.guid as reStaffLogGuid
,t.staff_user_id as staffUserId
...
coz_serve_org t2
on t.seorg_guid=t2.guid
where t1.del_flag=''0'' and t.del_flag=''0'' and t.detach_flag=''1'' and t.seorg_guid=''{curUserId}'' and (t1.user_name like ''%{userName}%'' or t1.phonenumber like ''%{userName}%'' or ''{userName}''='''')
)t
order by t.id desc
limit ?,?;
';
