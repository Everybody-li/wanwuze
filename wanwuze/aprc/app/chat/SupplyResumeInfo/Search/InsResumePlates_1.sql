-- ##Title app-沟通模式-供方(招聘方)-入库人才查找-提交查询条件-板块字段及值信息
-- ##Author lith
-- ##CreateTime 2024-11-18
-- ##Describe
-- ##CallType[ExSql]

-- ##input supplyResumeGuid char[36] NOTNULL;供方入库人才查找条件guid
...
insert into
    coz_chat_supply_resume_plate( guid, supply_resume_guid, plate_formal_guid, plate_formal_alias, plate_code
                                , plate_norder
