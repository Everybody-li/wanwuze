-- ##Title app-招聘-招聘进展管理-邀约信息管理-邀约记录管理-邀约等待信息-列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe app-招聘-查询所有投递等待的需求列表
-- ##CallType[QueryData]
...
,(select count(1) from coz_chat_supply_request_demand where de_request_guid=t.guid and recommend_type=''2'') as recruitCount
,(select count(1) from coz_chat_supply_request_demand where de_request_guid=t.guid and recommend_type=''2'' and deuser_read_flag=''2'') as deUserUnReadCount
