...
;
set @flag1=(select case when not exists (select 1 from coz_order where (guid='{orderGuid}' or parent_guid='{orderGuid}' or guid=@parent_guid) and supply_done_flag='0' and accept_way<>'1') then '1' else '0' end)
;
...
from
coz_order t
where (guid='{orderGuid}' or parent_guid='{orderGuid}' or guid=@parent_guid) and @flag1='1' and @flag2='1' and '{acceptStatus}'='1'
;
update coz_order
set accept_way='1'
...
,update_by='{curUserId}'
,update_time=now()
where (guid='{orderGuid}' or guid=@parent_guid) and @flag1='1' and @flag2='1'
;
update coz_order
set accept_way='2'
,accept_status='{acceptStatus}'
...
,update_by='{curUserId}'
,update_time=now()
where (parent_guid='{orderGuid}') and @flag1='1' and @flag2='1'
;
...
from
coz_order t
where guid='{orderGuid}' and @flag1='1' and @flag2='1' and '{acceptStatus}'='1'