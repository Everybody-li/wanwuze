...
,concat(left(t.prove_time,4),'年',right(left(t.prove_time,7),2),'月',right(left(t.prove_time,10),2),'日') as proveTime
,t.prove_imgs as proveImgs
,t.prove_supply_sign_date as proveSupplySignDate
,t.prove_supply_sign_imgs as proveSupplySignImgs
from
coz_order_refund t
left join
coz_order t1
