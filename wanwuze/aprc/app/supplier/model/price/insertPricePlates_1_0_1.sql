...
insert into coz_category_supplier_model_price_plate(guid,model_guid,model_price_guid,plate_formal_guid,plate_formal_alias,plate_code,plate_norder,plate_field_formal_guid,plate_field_formal_alias,plate_field_norder,plate_field_code,plate_field_content_gc,plate_field_value,operation,del_flag,create_by,create_time,update_by,update_time)
select
uuid() as guid
