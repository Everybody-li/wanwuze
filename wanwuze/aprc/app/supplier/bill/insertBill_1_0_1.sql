...
insert into coz_category_supplier_bill(guid,supplier_guid,plate_formal_guid,plate_code,plate_formal_alias,plate_norder,plate_field_formal_guid,plate_field_formal_alias,plate_field_code,plate_field_norder,plate_field_content_gc,operation,plate_field_value,del_flag,create_by,create_time)
select
uuid() as guid
