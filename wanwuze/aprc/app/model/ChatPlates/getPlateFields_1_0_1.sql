...
# ,CONCAT('{111ChildRows111_aprc\\app\\model\\ChatPlates\\getFieldContents_1_0_1:fieldGuid=''',t.guid,''' and cat_tree_code=''',t.cat_tree_code,''' and fieldname=''',t.name,''' and content_source=',t.content_source,'}') as `content`
,CONCAT('{ChildRows_aprc\\app\\model\\ChatPlates\\getFieldContents_1_0_1:fieldGuid=''',t.guid,'''}') as `content`
from
