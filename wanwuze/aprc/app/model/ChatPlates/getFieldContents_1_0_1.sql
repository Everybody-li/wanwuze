...
from
    (
        ...
        where
          ...
          and (t4.guid is null or (t4.parent_guid = '0' and t4.del_flag = '0')) --  查固化库
        union all
        select
            t1.guid    as fieldGuid
          , t2.content as `key`
        ...
        where
          ...
          and (t4.guid is null or (t4.parent_guid = '0' and t4.del_flag = '0'))
        union all
        select
            t5_su.guid as fieldGuid
          , t2.content as `key`
