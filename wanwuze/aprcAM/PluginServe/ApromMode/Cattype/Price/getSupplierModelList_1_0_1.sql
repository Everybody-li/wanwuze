-- ##Title 插件端-web后台-审批模式-通用配置-供应报价信息管理-发布逻辑-查询供方型号产品介绍列表
-- ##Author 卢文彪
...
select
t.guid as modelGuid
,CONCAT('{ChildRows_aprcAM\\PluginServe\\ApromMode\\Cattype\\Price\\getModelPlFieldList_1_0_1:modelGuid=''',t.GUID,'''}') as `model`
from
