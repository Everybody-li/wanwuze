...
-- ##input plateNorder int[>=0] NOTNULL;板块名称排序
...
-- ##input plateFieldNorder int[>=0] NOTNULL;板块名称排序
-- ##input plateFieldValue string[200] NOTNULL;用户填写的值，存具体内容，例如输入的字符内容或者图片/文件模板地址
-- ##input curUserId char[36] NOTNULL;当前登录用户id
-- ##input plateFieldContentCode string[6] NULL;固化字段内容值code
-- ##input plateFieldCode string[6] NULL;固化字段名称code
-- ##input plateFieldValueRemark string[200] NULL;板块字段业务扩展值，非必填

insert into coz_category_supplier_am_model_price_plate
( guid
, model_guid
, plate_formal_guid
, plate_formal_alias
...
select uuid()                                                                            as guid
     ...
     , '{plateFieldValueRemark}'                                                         as plateFieldValueRemark
     , '{plateFieldContentCode}'                                                         as plateFieldContentCode
     , '{plateFieldCode}'                                                                as plateFieldCode
