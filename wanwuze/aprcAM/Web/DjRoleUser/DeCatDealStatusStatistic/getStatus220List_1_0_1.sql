-- ##Title web-对接专员操作管理-购方/供方对接管理-购方用户采购管理/供应渠道供应管理-交易模式-查看详情(订单验收通过)
-- ##Author 卢文彪
-- ##CreateTime 2023-09-13
-- ##Describe 查询 目标所属类型的品类采购交易状态下的订单验收通过信息t1的业务guid=t2.guid
-- ##Describe 其他过滤条件:t3.需方已验收通过
...
-- ##output operationTime220 char[19] 2023-12-12 12:12:12;订单验收通过日期
...
select
    left(t3.accept_time, 19)       as operationTime220
...
from
    ...
    left join coz_demand_request_supply   t5
