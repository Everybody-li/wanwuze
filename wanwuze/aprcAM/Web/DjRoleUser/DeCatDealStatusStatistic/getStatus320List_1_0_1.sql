-- ##Title web-对接专员操作管理-购方/供方对接管理-购方用户采购管理/供应渠道供应管理-审批模式-查看详情(供方办理通知)
-- ##Author 卢文彪
-- ##CreateTime 2023-09-13
-- ##Describe 查询 目标所属类型的品类采购交易状态下的供方办理通知信息,t1.业务guid=t2.guid
-- ##Describe 其他过滤条件:t2.支付状态是支付成功
...
-- ##output operationTime320 char[19] 2023-12-12 12:12:12;供方办理通知日期
...
select left(t6.create_time, 19)        as operationTime320
