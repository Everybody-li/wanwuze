-- ##Title web-对接专员操作管理-购方/供方对接管理-购方用户采购管理/供应渠道供应管理-审批模式-供方办理通知-查看交易有关人员
-- ##Author 卢文彪
...
-- ##input bizGuid char[36] NOTNULL;业务guid:供方办理通知-订单guid
...
from coz_server3_cate_dealstatus_statistic t1
         ...
         inner join coz_order_am_notice coamno on corder.guid = coamno.order_guid
