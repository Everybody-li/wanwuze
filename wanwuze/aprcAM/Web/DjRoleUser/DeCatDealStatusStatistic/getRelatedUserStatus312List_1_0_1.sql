-- ##Title web-对接专员操作管理-购方/供方对接管理-购方用户采购管理/供应渠道供应管理-审批模式-办理申请点击-二维码/非二维码-查看交易有关人员
-- ##Author 卢文彪
-- ##CreateTime 2023-11-22
-- ##Describe 其他过滤条件:
-- ##Describe 表名：coz_server3_cate_dealstatus_statistic,sys_app_user,coz_server3_cate_dealstatus_statistic_detail,coz_cattype_sd_path,coz_lgcode_fixed_data,coz_org_info,coz_server3_sys_user_dj_bind,sys_user
-- ##CallType[QueryData]

-- ##input bizGuid char[36] NOTNULL;业务guid:办理申请点击-渠道预提交需求guid
...
from coz_server3_cate_dealstatus_statistic t1
         ...
         inner join coz_org_info coi on t2.supply_user_id = coi.user_id
...
where t1.del_flag = '0'
  and t2.del_flag = '0'
  and t1.dstatus = '312'
  and t1.biz_guid = '{bizGuid}'
  and t2.biz_guid = '{modelGuid}'
