-- ##Title web-结算专员操作管理-需方采购结算管理-需方退货退款支付-审批模式-已结算
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-结算专员操作管理-需方采购结算管理-需方退货退款支付-审批模式-已结算
-- ##CallType[QueryData]
...
-- ##output refundPayTime char[10] 退款日期;退款日期 （格式：0000-00-00）
...
where 
left(t.create_time,7)=''{month}'' and t.del_flag=''0'' and (t1.order_no like ''%{orderNo}%'' or ''{orderNo}''='''') and (t.cancel_object=''2'') and t.refund_pay_status=''2''
)t
