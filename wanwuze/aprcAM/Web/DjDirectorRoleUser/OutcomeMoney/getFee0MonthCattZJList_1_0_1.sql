-- ##Title web-服务主管操作管理-服务主管业绩管理-购方/供方对接业绩管理-服务免费-资金资源需求-方案金额月份详情-查询列表
-- ##Author 卢文彪
-- ##CreateTime 2023-12-20
-- ##Describe 查询当前服务主管的业绩列表:某一月份下,查询归属服务主管的服务专员列表,求和与服务主管关联的corder的服务定价基数(unit_fee),按服务专员和corder的验收通过时间的年份和月度分组求和,排序先待定
-- ##Describe 查询条件:t1表中品类状态是验收通过,含交易模式和审批模式,t1的需方/供方对接专员是入参对接专员guid,t2的服务主管guid是入参目标用户id,cdr的收取服务费是免费,品类类型是资金资源需求
-- ##Describe 表名：coz_server3_cate_dealstatus_statistic t1,coz_server3_cate_dealstatus_statistic_outcome t2,coz_order corder,coz_demand_request cdr,sys_user su
-- ##CallType[QueryData]
...
group by left(t3.accept_time, 7),left(t5.create_time, 19),t5.user_name,t5.phonenumber,t5.user_id
)t
