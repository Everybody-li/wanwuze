-- ##Title web-服务主管操作管理-服务主管业绩管理-购方/供方对接业绩管理-服务免费-资金资源需求-方案金额月份详情-方案金额机构详情-方案金额订单详情-查询列表
-- ##Author 卢文彪
-- ##CreateTime 2023-12-20
-- ##Describe 查询当前服务主管的业绩列表:某一月份下,查询归属服务主管的服务专员的有订单验收通过的订单列表,求和corder的服务定价基数(unit_fee),按订单验收通过时间升序,订单支付时间升序
-- ##Describe 查询条件:t1表中品类状态是验收通过,含交易模式和审批模式,t1的需方/供方对接专员是入参对接专员guid,t1的供方是入参机构用户id,t2的服务主管guid是入参目标用户id,cdr的收取服务费是免费,品类类型是资金资源需求
...
where t1.del_flag = '0'
  ...
  and t4.serve_fee_flag='0' and left(t3.accept_time,7)='{month}' and t1.cattype_guid='43cabc5d-f1ce-11ec-bace-0242ac120003' and (t4.user_phone like'%{supplyUserPhone}%' or '{supplyUserPhone}'='')
