...
-- ##input modelGuid string[4000] NOTNULL;型号guid，支持多个
...
-- ##output plates.plateFieldCode string[20] 字段名称code;

select t.model_guid                as modelGuid,
       CONCAT('{ChildRows_aprcAM\\Java\\Web\\Modelprice\\getSupplierModelPricePlateValuesByMGuidAndFieldCodes_1_0_1:modelGuid=''',
              t.model_guid, '''}') as `plates`
from coz_category_supplier_am_model_plate t
