-- ##Title web-服务主管操作管理-服务主管业绩管理-购方/供方对接业绩管理-服务收费-查询列表
-- ##Author 卢文彪
-- ##CreateTime 2023-12-20
-- ##Describe 查询当前服务主管的业绩列表,求和与服务主管关联的corder的需方服务费用,按corder的验收通过时间的年份和月度分组统计,按验收通过倒序
