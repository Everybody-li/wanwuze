-- ##Title web-对接专员操作管理-购方/供方对接管理-购方用户采购管理/供应渠道供应管理-交易模式-需方取消订单-查看交易有关人员
-- ##Author 卢文彪
...
-- ##input bizGuid char[36] NOTNULL;业务guid:需方取消订单-订单取消guid
...
select
  ...
  , concat('(+86)', t1.supply_user_phone) as orgPhone
