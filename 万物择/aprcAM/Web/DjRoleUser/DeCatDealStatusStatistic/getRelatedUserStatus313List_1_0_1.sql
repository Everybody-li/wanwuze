-- ##Title web-对接专员操作管理-购方/供方对接管理-购方用户采购管理/供应渠道供应管理-审批模式-办理申请提交-查看交易有关人员
-- ##Author 卢文彪
-- ##CreateTime 2023-11-22
-- ##Describe 其他过滤条件:coz_demand_request.需求已取消
...
-- ##input bizGuid char[36] NOTNULL;业务guid:办理申请提交-需求guid
...
select t2.user_name                      as demandUserName
...
from coz_server3_cate_dealstatus_statistic t1
         ...
         inner join coz_cattype_sd_path cdp on t2.sd_path_guid = cdp.guid
...
where t1.del_flag = '0'
  and t2.del_flag = '0'
  and t1.dstatus = '313'
  and t1.biz_guid = '24cfbc85-db55-4788-8a40-e74813c23009';
