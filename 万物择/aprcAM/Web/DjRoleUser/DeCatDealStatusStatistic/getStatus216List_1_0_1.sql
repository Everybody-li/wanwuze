-- ##Title web-对接专员操作管理-购方/供方对接管理-购方用户采购管理/供应渠道供应管理-交易模式-查看详情(需方取消订单)
-- ##Author 卢文彪
-- ##CreateTime 2023-09-13
-- ##Describe 查询 目标所属类型的品类采购交易状态下的需方取消订单信息,t1.业务guid=t2.guid
-- ##Describe 其他过滤条件:t2.取消对象是需方取消,t4.仲裁结果未裁决
-- ##Describe 表名：coz_server3_cate_dealstatus_statistic t1,coz_order_cancel t2,coz_order_cancel t3,coz_order_judge t4,coz_order t5,coz_demand_request t6
-- ##CallType[QueryData]
...
-- ##output operationTime216 char[19] 2023-12-12 12:12:12;需方取消订单日期
...
select left(t5.create_time, 19)       as operationTime216
