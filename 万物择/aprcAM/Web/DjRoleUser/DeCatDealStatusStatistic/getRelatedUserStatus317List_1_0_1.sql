-- ##Title web-对接专员操作管理-购方/供方对接管理-购方用户采购管理/供应渠道供应管理-审批模式-需求采购支付-查看交易有关人员
-- ##Author 卢文彪
...
from coz_server3_cate_dealstatus_statistic t1
         ...
         left join coz_order_cancel cocancel on corder.guid = cocancel.order_guid
