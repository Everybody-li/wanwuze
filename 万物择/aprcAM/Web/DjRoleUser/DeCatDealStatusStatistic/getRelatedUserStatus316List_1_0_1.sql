-- ##Title web-对接专员操作管理-购方/供方对接管理-购方用户采购管理/供应渠道供应管理-审批模式-供方供应报价-查看交易有关人员
-- ##Author 卢文彪
...
-- ##input bizGuid char[36] NOTNULL;业务guid:供方供应报价-需求报价guid
...
from coz_server3_cate_dealstatus_statistic t1
         inner join coz_demand_request_price drp on t1.biz_guid = drp.guid
         inner join coz_demand_request dr on drp.request_guid = dr.guid
