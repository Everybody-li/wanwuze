-- ##Title web-对接专员操作管理-购方对接管理-购方用户采购管理-查询列表
-- ##Author 卢文彪
-- ##CreateTime 2023-09-11
-- ##Describe 查询对接专员绑定的的需方用户列表
-- ##Describe 表名： coz_server3_sys_user_dj_bind t1,sys_app_user t2
-- ##CallType[QueryData]
...
-- ##output bindTime string[16] 绑定日期;绑定日期
...
,t.binded_user_id as demandUserId
from
