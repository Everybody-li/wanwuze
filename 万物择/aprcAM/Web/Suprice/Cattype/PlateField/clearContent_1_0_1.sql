-- ##Title web后台-审批模式-通用配置/配置管理-供应报价信息管理-供应报价信息配置-字段名称配置-字段内容配置-字段内容管理-清空
-- ##Author 卢文彪
-- ##CreateTime 2023-07-27
-- ##Describe 删除当前品类名称的所有字段名称及字段名称的字段内容信息，操作后每次都调用接口改主表发布状态：aprcAM\Web\Suprice\Cattype\Price\updPublishFlag2UnPub_1_0_1
