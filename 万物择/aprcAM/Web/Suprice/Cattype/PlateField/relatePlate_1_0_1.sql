-- ##Title web后台-审批模式-通用配置/配置管理-供应报价信息管理-供应报价信息配置-字段名称配置-关联板块名称
-- ##Author 卢文彪
-- ##CreateTime 2023-07-27
-- ##Describe 关联板块名称，相同品类guid下板块名称不重复关联，操作后每次都调用接口改主表发布状态：aprcAM\Web\Suprice\Cattype\Mode\updPublishFlag2UnPub_1_0_1
