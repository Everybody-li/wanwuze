-- ##Title web后台-审批模式-通用配置-供需需求信息管理-信息格式排序-字段名称-查询板块下的子孙级字段名称列表
-- ##Author 卢文彪
-- ##CreateTime 2023-07-26
-- ##Describe 查询入参字段名称下关联的字段名称列表
-- ##Describe 查出参”是否有字段内容关联字段名称“逻辑：关联的字段名称的有自建内容且也关联了字段名称，则为是，否则为否
...
where
t.del_flag='0' and t1.del_flag='0' and t1.cat_tree_code='{catTreeCode}' and exists(select 1 from coz_model_am_aprom_plate_field_content where del_flag='0' and relate_field_guid=t.guid and plate_field_guid='{plateFieldGuid}')