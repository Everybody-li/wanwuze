-- ##Title web后台-审批模式-通用配置-供需需求信息管理-采购/供应需求信息配置-字段名称配置-字段内容配置-字段内容管理-添加库名称
-- ##Author 卢文彪
...
-- ##input fixedDataCodeGuid string[36] NOTNULL;固化库名称Guid
-- ##input curUserId char[36] NOTNULL;当前登录用户id

update coz_model_am_aprom_plate_field
set content_fixed_data_guid='{fixedDataCodeGuid}'
,update_by='{curUserId}'
,update_time=now()
