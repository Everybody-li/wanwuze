-- ##Title web后台-审批模式-通用配置-供需需求信息管理-采购需求信息配置-字段内容配置-删除字段内容
-- ##Author 卢文彪
...
-- ##input categoryGuid char[36] NOTNULL;字段内容guid
-- ##input plateContentGuid char[36] NOTNULL;字段名称guid
