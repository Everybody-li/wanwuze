-- ##Title  web机构-审批模式-切换合作项目-需求范围管理-需求范围设置-型号模式-创建型号-获取板块列表
-- ##Author 卢文彪
...
,CONCAT('{ChildRows_aprcAM\\webSuOrg\\Am\\ModelInfo\\ModePlate\\getPlateFieldList_1_0_1:plateGuid=''',t.guid,'''}') as `fields`
from
