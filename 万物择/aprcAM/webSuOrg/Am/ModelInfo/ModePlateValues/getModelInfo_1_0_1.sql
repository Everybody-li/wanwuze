...
-- ##Describe 表名：coz_category_supplier_am_model,coz_category_supplier_am_model_plate
-- ##Describe 排序：板块的顺序升序
-- ##CallType[QueryData]
...
-- ##output fields.relateFlag enum[0,1] 1;字段名称是否隐藏：0-否，1-是。前端：仅显示未被隐藏的字段名称列表，已被隐藏的字段名称根据字段内容选中触发动态展示
...
-- ##output plates.fields.values.fieldBizGuid string[36] fieldBizGuid;fieldBizGuid

select
t.guid as modelGuid
,t.name as modelName
,CONCAT('{ChildRows_aprcAM\\webSuOrg\\Am\\ModelInfo\\ModePlateValues\\getPlates_1_0_1:modelGuid=''',t.guid,'''}') as `plates`
from
