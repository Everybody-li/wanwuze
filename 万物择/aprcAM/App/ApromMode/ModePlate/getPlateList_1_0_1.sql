-- ##Title app-管理-审批模式下的品类-融资渠道选择-渠道需求页面加载-获取板块列表
-- ##Author 卢文彪
...
-- ##input catTreeCode enum[demand,supply] NOTNULL;供需区分：demand-采购需求信息，supply-供应信息
...
-- ##output fields.plateFieldAlias int[>0] 字段名称别名;字段名称别名
-- ##output fields.plateFieldNorder int[>0] 字段名称排序;字段名称排序
...
,CONCAT('{ChildRows_aprcAM\\App\\ApromMode\\ModePlate\\getPlateFieldList_1_0_1:plateGuid=''',t.guid,'''}') as `fields`
from
coz_model_am_aprom_plate_formal t
