-- ##Title 插件端-web后台-审批模式-供应报价信息管理-发布逻辑-查询供方型号产品介绍字段名称列表
-- ##Author 卢文彪
...
,CONCAT('{ChildRows_aprcAM\\PluginServe\\ApromMode\\Cattype\\Price\\getModelPlFieldContList_1_0_1:plateFieldGuid=''',t.plate_field_formal_guid,''' and modelGuid=''',t.model_guid,'''}') as `fields`
