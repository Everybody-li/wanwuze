-- ##Title 品类-查询字节内容自己及子孙列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe 品类-查询字节内容自己及子孙列表
-- ##CallType[QueryData]
...
,t.level
,t.norder
,case when exists(select 1 from coz_category_name_tree where parent_guid=t.guid and del_flag='0') then '1' else '0' end as hasSon
from
coz_category_name_tree t
where 
(guid='{nameTreeGuid}' or all_parent_id like '{url:[http://127.0.0.1:8011/html?SqlCmdName=aprc\java\cat\nt\allParentId&DBC=w_a&nameTreeGuid={nameTreeGuid}&OnlyTagReturn=true]/url}') and del_flag='0'