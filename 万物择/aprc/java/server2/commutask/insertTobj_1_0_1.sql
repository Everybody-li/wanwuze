...
-- ##input commuTaskGuid string[50] NOTNULL;品类名称guid，必填
...
insert into coz_serve2_commu_task_tobject(guid,commu_task_guid,object_guid,object_org_guid,result,del_flag,create_by,create_time,update_by,update_time)
select
uuid() as guid
,'{commuTaskGuid}' as commu_task_guid
