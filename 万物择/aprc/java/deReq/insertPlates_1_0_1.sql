-- ##Title 新增或修改型号的需求范围，多条
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe 新增或修改型号的需求范围，多条
-- ##CallType[ExSql]
...
-- ##input plateCode string[50] NOTNULL;板块字段名称code(固化时有值)，必填
...
-- ##input plateFieldFDCode string[50] NULL;板块字段名称code(固化时有值)，非必填
...
insert into coz_demand_request_plate(guid,request_guid,plate_formal_guid,plate_formal_alias,plate_code,plate_norder,plate_field_formal_guid,plate_field_formal_alias,plate_field_code,plate_field_norder,plate_field_content_gc,operation,plate_field_value,del_flag,create_by,create_time)
select
uuid() as guid
