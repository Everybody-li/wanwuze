...
;
update coz_org_info_lgcode 
set 
del_flag='2'
,update_by='{curUserId}'
,update_time=now()
where user_id=@userid and @flag1='1'
;
delete from coz_org_gyv2_relate_staff where org_user_id=@userid
;
...
,update_by='{curUserId}'
where
org_user_id=@userid and detach_flag='0'
;
select 
