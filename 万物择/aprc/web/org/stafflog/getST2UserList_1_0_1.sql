...
-- ##input orgUserGuid char[36] NULL;品类名称，非必填
...
where t1.del_flag=''0'' and t2.del_flag=''0'' and t3.del_flag=''0'' and t4.del_flag=''0'' and t5.del_flag=''0'' and t6.del_flag=''0'' and t1.user_id=''{orgUserGuid}'' and t2.detach_flag=''0'' and t3.detach_flag=''0''
order by t2.id desc
limit ?,?;
';
