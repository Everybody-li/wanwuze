...
,t.norder
,case when exists(select 1 from coz_model_plate_field where plate_guid=t.guid and del_flag='0') then '1' else '0' end as hasSon
from
coz_model_plate t
inner join
...
where 
t.cat_tree_code='{catTreeCode}' and t.category_guid='{categoryGuid}' and t.biz_type={bizType} and t.del_flag='0' and t1.del_flag='0' and t1.biz_type='{fixedDataBizType}' and (t.fixed_data_code like '%{plateFixedDataCode}%'or '{plateFixedDataCode}'='')
