...
set
  ...
  , update_time=now()
  , publish_time=0
where @bizType = 1  and @Flag4='1' and category_guid = @categoryGuid and publish_flag= '2';
...
set
  ...
  , update_time=now()
  , publish_time= null
where @bizType = 2  and @Flag4='1' and category_guid = @categoryGuid and publish_flag= '2';
