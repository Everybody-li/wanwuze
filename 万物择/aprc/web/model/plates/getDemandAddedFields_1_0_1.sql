...
where 
cat_tree_code='demand' and category_guid='{categoryGuid}' and (operation='1' or operation='2' or operation='3') and biz_type='1' and del_flag='0' and not exists(select 1 from coz_model_plate_field where cat_tree_code='supply' and category_guid='{categoryGuid}'and biz_type='1' and del_flag='0' and name=t.name)
)t
