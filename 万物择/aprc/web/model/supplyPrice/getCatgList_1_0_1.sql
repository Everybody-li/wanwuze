-- ##Title web-品类名称查询供应报价信息列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-品类名称查询供应报价信息列表
-- ##CallType[QueryData]
...
select
  ...
  , case
        when exists(select 1
                    ...
                    where t.categoryGuid = category_guid and biz_type = '2' and publish_flag = '0' and del_flag = '0')
            or exists(select 1
                      from
