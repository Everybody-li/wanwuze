...
where 
t1.del_flag='0' and t1.biz_type='{fixedDataBizType}' and t1.type='1'
  and not exists(select 1 from coz_model_chat_plate where cat_tree_code='{catTreeCode}' and category_guid='{categoryGuid}'  and del_flag='0' and fixed_data_code=t1.code)
  and exists(select 1 from coz_model_chat_plate where cat_tree_code='demand' and category_guid='{categoryGuid}'  and del_flag='0' and fixed_data_code=t1.code)
order by t1.id
