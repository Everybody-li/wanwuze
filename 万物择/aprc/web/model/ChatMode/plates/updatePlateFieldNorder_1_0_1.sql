...
,update_by='{curUserId}'
,update_time=now()
where norder<={newNorder} and norder>={norder} and category_guid=@categoryGuid and cat_tree_code=@catTreeCode and @norderflag>=0 and guid<>'{plateFieldGuid}' and @flag1=1 and del_flag='0'
;
