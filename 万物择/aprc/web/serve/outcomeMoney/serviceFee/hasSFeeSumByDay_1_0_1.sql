-- ##Title web-查询交易收入管理-日期详情(某日期下的品类类型详情)
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-查询交易收入管理-日期详情(某日期下的品类类型详情)
-- ##CallType[QueryData]
...
where t1.del_flag='0' and t2.del_flag='0' and t2.serve_fee_flag='{serveFeeFlag}' and t1.pay_status='2' and t1.accept_status='1' and  left(t1.create_time,10)='{day}'
group by t2.cattype_guid,t2.cattype_name
order by t2.cattype_name