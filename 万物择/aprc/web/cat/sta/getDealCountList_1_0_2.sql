...
,(select count(1) from coz_demand_request a inner join coz_order b on b.request_guid=a.guid where a.category_guid=t.guid and a.del_flag=''0'' and b.del_flag=''0'' and b.pay_status=''2'' and b.accept_status=''1'')  as acceptOrderNum
from  
coz_category_info t
where 
(t.name like ''%{categoryName}%'' or ''{categoryName}''='''') and t.del_flag=''0'' and t.cattype_guid=''{cattypeGuid}'' and t.mode=2
