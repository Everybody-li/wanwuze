-- ##Title 运营经理操作系统-品类交易管理-品类供应渠道管理-审批模式-有供应渠道-查看供应渠道详情-查看供应型号详情-表头中部选项卡型号上架和未上架数量
-- ##Author 卢文彪
