-- ##Title web-查询需求供应报价管理
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-查询需求供应报价管理
-- ##CallType[QueryData]

-- ##input categoryGuid char[36] NULL;机构名称(模糊搜索)，非必填
...
where 
(t1.cancel_xjsuser_read_flag=''0'' or t1.cancel_xjsuser_read_flag=''1'') and t1.del_flag=''0'' and (t1.done_flag_xjsuser_read_flag=''0'' or t1.done_flag_xjsuser_read_flag=''1'') and t1.category_guid=''{categoryGuid}''
