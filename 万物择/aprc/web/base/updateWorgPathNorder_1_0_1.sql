...
set worg_norder='{oldNorder}'
,update_by='{curUserId}'
,update_time=now()
where guid='{guid}' and parent_guid=@parentGuid and worg_norder='{newNorder}' and '{pathType}'='demand'
;
update coz_cattype_demand_path
set worg_norder='{newNorder}'
,update_by='{curUserId}'
,update_time=now()
...
,update_by='{curUserId}'
,update_time=now()
where guid='{guid}' and parent_guid=@parentGuid and worg_norder='{newNorder}' and '{pathType}'='supply'
;
update coz_cattype_supply_path
set worg_norder='{newNorder}'
,update_by='{curUserId}'
