-- ##Title web-查询某一品类服务机构供方定价列表-按型号名称
-- 使用方:WebAPP
-- ##Author 卢文彪
-- ##CreateTime 2019-07-08
-- ##Describe web-查询某一品类服务机构供方定价列表-按型号名称
-- ##CallType[QueryData]
...
where
t.category_guid=''{categoryGuid}''and t.del_flag=''0'' and (t1.phonenumber like''%{phonenumber}%'' or ''{phonenumber}''='''') and t.user_type=''2''
order by t.id desc
limit ?,?;
';
