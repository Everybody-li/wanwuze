...
;
delete from coz_serve_org_relate_staff where seorg_guid='{seorgGuid}' and staff_type='3' and @flag1='1' and @flag2='1' and @flag3='1'
;
...
,detach_by='{seorgGuid}'
where
seorg_guid='{seorgGuid}' and staff_type='3' and detach_flag='0' and @flag1='1' and @flag2='1' and @flag3='1'
;
