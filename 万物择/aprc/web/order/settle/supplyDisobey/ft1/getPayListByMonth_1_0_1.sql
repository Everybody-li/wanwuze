-- ##Title web-结算管理-已结算列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-结算管理-已结算列表
-- ##CallType[QueryData]
...
-- ##output confirmPayTime string[10] 0000-00-00;确认处罚收取日期（格式：0000-00-00）
...
where 
left(t.create_time,7)=''{month}'' and t.del_flag=0 and (t1.order_no like ''%{orderNo}%'' or ''{orderNo}''='''') and t.fee_type=''1'' and t4.disobey_object=''2'' and t.confirm_pay_flag=''2''
