-- ##Title web-查看供方违约赔偿支付列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-查看供方违约赔偿支付列表
-- ##CallType[QueryData]
...
(
	...
	(
		select
		left(result_time,7) as createDate
		...
		where 
		t.pay_type=''0'' and t.del_flag=''0'' and t1.disobey_object=''2'' and t.fee_type=''2''
		group by left(t1.result_time,7)
		union all
		select
		left(result_time,7) as createDate
		,0 as waitPayFee
