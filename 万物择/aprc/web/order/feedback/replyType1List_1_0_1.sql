-- ##Title web-查看采购退货退款意见反馈列表-已回复
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-查看采购退货退款意见反馈列表-已回复
-- ##CallType[QueryData]
...
where 
(t.order_no like'%{orderNo}%' or '{orderNo}'='') and t.del_flag='0' and t.cat_tree_code='demand' and t.reply_flag='2'
