-- ##Title web-更新用户品类供应操作权限
-- 使用方:WebAPP
-- ##Author 卢文彪
-- ##CreateTime 2019-07-08
-- ##Describe web-更新用户品类供应操作权限
-- ##CallType[ExSql]
...
set del_flag='2'
where request_guid in(select guid from coz_demand_request where done_flag='0' and category_guid='{categoryGuid}' and del_flag='0') and del_flag='0 ' and user_id='{userId}' and supply_price_status='1'
;
update coz_category_supplier
set del_flag='2'
where category_guid='{categoryGuid}' and user_id='{userId}' and del_flag='0'
;