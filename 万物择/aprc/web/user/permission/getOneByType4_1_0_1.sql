-- ##Title web-查看用户操作权限（品类采购操作权限）
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-查看用户操作权限（品类采购操作权限）
-- ##CallType[QueryData]
...
-- ##output permissonDetailGuid char[36] 用户品类权限guid;用户品类权限guid
