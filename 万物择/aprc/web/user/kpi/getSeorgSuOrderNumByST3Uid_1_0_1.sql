-- ##Title web-招募专员成果-查询供应对接成果列表
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe web-招募专员成果-查询供应对接成果列表
-- ##CallType[QueryData]
...
,(select count(1) from coz_serve_order_kpi where supply_seorg_stalog_st3_guid=t1.guid and del_flag=''0'') as orderNum
from
