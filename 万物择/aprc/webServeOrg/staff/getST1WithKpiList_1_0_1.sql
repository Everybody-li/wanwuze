...
select
*
,(select count(1) from coz_serve_order_kpi where demand_gauser_id=t.staff_user_id and del_flag=''0'') as orderNum
from
(
select
...
where t1.del_flag=''0'' and t.del_flag=''0'' and t.staff_type=''1'' and t.seorg_guid=''{seorgGuid}'' and (t1.user_name like ''%{phonenumber}%'' or t1.phonenumber like ''%{phonenumber}%'' or ''{phonenumber}''='''')
)t
group by t.userGuid,t.seorgGuid,t.openingTime,t.userName,t.nation,t.phonenumber,t.staff_user_id
