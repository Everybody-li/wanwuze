-- ##Title app-招聘方式管理-应聘人员查找-查询应聘人员
-- ##Author lith
...
-- ##output totalCount int[>=0] 1;符合查询条件数量
-- ##output deRequestGuid char[36] ;招聘方需求Guid
-- ##output users.recruitGuid char[36] ;应聘工作信息Guid
-- ##output users.supplyUserId char[36] ;应聘方用户id
-- ##output users.supplyUserName string[100] ;应聘方用户名称
-- ##output users.supplyUserResumeImg char[36] ;应聘方简介图片:图片相对路径
-- ##output users.supplyUserPhone string[50] ;应聘方手机号
