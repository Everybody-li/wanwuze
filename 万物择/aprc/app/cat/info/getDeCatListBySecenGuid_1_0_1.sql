                  ...
                  select t.guid           as categoryGuid
                       ...
                       , case
                             when (exists(select 1
                                   ...
                                   exists(select 1 from {url:[http://127.0.0.1:8011/html?SqlCmdName=aprcAM\Com\Utils\Model\getModeTableNamePrefixBySCGuid_1_0_1&secenGuid={secenGuid}&DBC=w_a]/url}_log where category_guid=t.guid) and
                                   exists(select 1 from {url:[http://127.0.0.1:8011/html?SqlCmdName=aprcAM\Com\Utils\Model\getSPriceTableNamePrefixBySCGuid_1_0_1&secenGuid={secenGuid}&DBC=w_a]/url}_log where category_guid=t.guid) and
