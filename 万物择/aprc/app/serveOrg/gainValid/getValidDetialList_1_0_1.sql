-- ##Title ﻿﻿app-权限用户信息的权限详情
-- ##Author 卢文彪
-- ##CreateTime 2020-06-05
-- ##Describe ﻿﻿app-权限用户信息的权限详情
-- ##CallType[QueryData]
...
where
t1.user_id=''{curUserId}'' and t1.del_flag=''0'' and t2.del_flag=''0'' and t3.del_flag=''0'' and left(t1.create_time,10)=''{createTime}'' and t1.takeback_flag=''0''  and t2.takeback_flag=''0'' and (t2.object_name like ''%{phonenumber}%'' or t2.object_phonenumber like ''%{phonenumber}%'' or ''{phonenumber}''='''')
order by t1.id desc
limit ?,?;
';
