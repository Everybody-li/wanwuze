...
,t.operation
,CONCAT('{ChildRows_aprc\\webSuOrg\\supplier\\model\\price\\plates\\getPlateFieldValues_1_0_1:fieldGuid=''',t.plate_field_formal_guid,'''}') as `values`
from
coz_category_supplier_model_price_plate t
where
t.model_price_guid='{modelPriceGuid}'and t.del_flag='0'
group by t.plate_field_norder,t.plate_field_formal_alias,t.plate_formal_guid,t.plate_field_formal_guid,t.operation,t.plate_field_code,t.plate_field_content_gc,t.plate_field_value_remark