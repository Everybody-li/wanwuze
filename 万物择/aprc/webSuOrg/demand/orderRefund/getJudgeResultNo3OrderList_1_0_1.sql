...
where 
t3.supply_user_id=''{curUserId}'' and t3.sd_path_guid=''{sdPathGuid}''  and t1.supply_accept=''0'' and t2.result in (''1'',''2'')
union all
select 
t2.guid as judgeGuid
,t3.supply_user_id as supplyUserId
...
on t3.category_guid=t4.guid 
where 
t3.supply_user_id=''{curUserId}'' and t3.sd_path_guid=''{sdPathGuid}''  and t1.refund_pay_status=''0''and t2.result in (''1'',''2'')
)t
